<?php
    ...
    if (isset($_POST['screenName'])) {
        if (!empty($_POST['screenName'])) {
            ...
            $birthDate = $getFromU->checkInput($_POST['birthDate']);
            ...
            if (strlen($screenName) > 20) {
                ...
                $getFromU->update('users', $user_id, array('screenName' => $screenName, 'bio' => $profileBio, 'country' => $country, 'website' => $website, 'gender' => $gender, 'birthDate' => $birthDate));
...
<head>
	...
	<link rel="stylesheet" href="assets/css/style-complete1.css"/>
				...
				<div class="profile-bio-wrap">
					...
					<div class="profile-extra-inner">
						<ul>
                            ...
                            <li>
								<div class="profile-ex-location">
                                    <lable  for="gender" > Gender : <?php echo $user->gender; ?> <br>change</lable>
                                    <select name="gender" autofocus="<?php echo $user->gender; ?>">
                            ...
                            <li>
								<div class="profile-ex-location">
                                    <lable  for="birthDate" > Birth Date : <?php echo $user->birthDate; ?> <br>change</lable>
